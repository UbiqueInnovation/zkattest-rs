...
use crypto_bigint::{subtle::Choice, AddMod, Integer, InvMod, MulMod, SubMod};
...
pub struct ScalarMultiplicationProof<G1, const N1: usize, G2, const N2: usize>
where
    G1: Group<N1>,
    G2: Group<N2>,
{
    params_g1: PedersenParams<G1, N1>,
    params_g2: PedersenParams<G2, N2>,
    s: G1::FieldElement,
    cs: Commitment<G1, N1>,
    p: G2,
    px: Commitment<G2, N2>,
    ...
    G2: Group<N2>,
{
    ...
    fn verify_from_hash(&self, msg_hash: &[u8]) -> bool {
        use group::ScalarElement;
